  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-indigo-500 text-neutral-50 hover:bg-indigo-500 hover:text-neutral-50 focus:bg-indigo-500 focus:text-neutral-50 dark:bg-neutral-50 dark:text-indigo-500 dark:hover:bg-neutral-50 dark:hover:text-indigo-500 dark:focus:bg-neutral-50 dark:focus:text-indigo-500",
        day_today: "bg-neutral-100 text-indigo-500 dark:bg-neutral-800 dark:text-neutral-50",
        day_outside:
        ...
        day_range_middle:
          "aria-selected:bg-neutral-100 aria-selected:text-indigo-500 dark:aria-selected:bg-neutral-800 dark:aria-selected:text-neutral-50",
